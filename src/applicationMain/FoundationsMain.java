...
public class FoundationsMain extends Application {
	...
	/**
	 * Constructor for FoundationsMain.
	 */
	...
	**********************************************************************************************/
	...
	/** The application window width used to provide a uniform size across classes. */
	public final static double WINDOW_WIDTH = 800;
	
	/** The application window height used to provide a uniform size across classes. */
	public final static double WINDOW_HEIGHT = 600;

	/** The shared database instance for the application to avoid passing it via parameters. */
	public static Database database = new Database();
    private Alert databaseInUse = new Alert(AlertType.INFORMATION);

	/** Which role's home page is currently active (0 is the admin role number). */
	...
	public void start(Stage theStage) {
		...
		try {
			...
			database.setupGradingAndTimestamps();
